...
| `data-form-classes`               | `string`              | `null`                                                                              | yes      | a parameter listing classes to apply to the `<form>` element (eg. form-inline for bootstrap)                        |
| `data-default-template`                 | `true` &#124; `false` | `true`                                                                              | no       | whether or not to load the default template (must include an email input and submit button in html if false)                                                                                          |
